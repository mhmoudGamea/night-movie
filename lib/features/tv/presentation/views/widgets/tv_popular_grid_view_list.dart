...
class TvPopularGridViewList extends StatefulWidget {
  final List<TvModel> model;
  const TvPopularGridViewList({Key? key, required this.model})
      : super(key: key);

  @override
  State<TvPopularGridViewList> createState() => _TvPopularGridViewListState();
}

class _TvPopularGridViewListState extends State<TvPopularGridViewList> {
